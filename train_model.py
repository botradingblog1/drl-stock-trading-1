...
from utils.gpu_utils import perform_cuda_checks
...
#  e.g. python train_model.py --cuda --run="botrain1"
if __name__ == "__main__":
    ...
    # cxs: Setting zero commission
    env_val = environ.StocksEnv(val_data, bars_count=BARS_COUNT, commission=0.0)
